...
function QualificationCheckerV2({ pathway, setPathway, result, setResult, checkQualification, setStep }) {
  ...
  const controls = pathway === 'Senior Certificate'
    ? [select('English (HG D or SG C)', 'english', ['HG A', 'HG B', 'HG C', 'HG D', 'SG A', 'SG B', 'SG C', 'Below requirement']), select('Biology (HG D or SG C)', 'biology', ['HG A', 'HG B', 'HG C', 'HG D', 'SG A', 'SG B', 'SG C', 'Below requirement']), select('Mathematics (HG D or SG C)', 'mathematics', ['HG A', 'HG B', 'HG C', 'HG D', 'SG A', 'SG B', 'SG C', 'Below requirement']), number('M score', 'mScore')]
