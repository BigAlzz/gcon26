...
function QualificationCheckerV2({ pathway, setPathway, result, setResult, checkQualification, setStep }) {
  ...
  const controls = pathway === 'Senior Certificate'
    ...
    : pathway === 'NC(V) Level 4'
      ...
      : [select('English level', 'english', ['4', '5', '6', '7', '3 or below']), select('Life Sciences level', 'lifeSciences', ['4', '5', '6', '7', '3 or below']), select('Mathematics level', 'mathematics', ['0', '4', '5', '6', '7', '3 or below']), select('Maths Literacy level', 'mathsLiteracy', ['0', '4', '5', '6', '7', 'Not taken']), number('Reported APS (LO half-weighted)', 'aps')];
