...
def build():
    ...
    add_table(doc, ["Pathway", "Current checker rule"], [
        ...
        ("Non-qualifying records", "Non-qualifying capture retains the applicant's entered pathway values, result status, failed criteria, score and contact details so the intake team can audit what was submitted. Local records are persisted in the encrypted store; hosted demo records are in-memory only."),
